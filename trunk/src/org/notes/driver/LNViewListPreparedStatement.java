...
public class LNViewListPreparedStatement extends LNStatement implements PreparedStatement {
	
	private Map param = new HashMap();
	private String sql=null;
	
	
	protected LNViewListPreparedStatement(LNConnection con,String sql)throws SQLException{
		super(con);
	    prepare(sql);
	}
	...
	public ResultSet executeQuery(String sql) throws SQLException{
		...
		prepare(sql);
		try {	
			Vector<View> views = con.getLNDatabase().getViews();
			return new LNViewListResultSet(this,views);
		} catch(Exception e) {
			throw new LNException("Notes Execute error: "+e.getMessage());
		}
	}
