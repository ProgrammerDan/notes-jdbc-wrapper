...
public class LNResultSetMetaData implements ResultSetMetaData {
	
	private List<String> header;
	
	protected LNResultSetMetaData(List<String> h){
		super();
		this.header=h;

		for(int i=0;i<this.header.size();i++){
			this.header.set(i,this.header.get(i).toLowerCase());
		}
	}
    ...
    public int getColumnIndex(String name) throws SQLException{
    	...
    	if(i==-1)throw new LNException("column name '"+name+"' not found in "+this.toString());
    	return i+1;
    }
