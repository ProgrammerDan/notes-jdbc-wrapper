...
import java.sql.*;
import lotus.domino.*;
import lotus.domino.cso.DateTime;
 ...
 */
public class LNViewResultSet implements ResultSet {

    private LNResultSetMetaData md = null;
    ...
    protected LNViewResultSet(Statement st, Vector columnsName, ViewEntryCollection columnsValue) throws Exception {
        this.statement = st;
 		md = new LNResultSetMetaData(columnsName);

		if (columnsValue!=null){
			ViewEntry row = columnsValue.getFirstEntry();
			while(row != null){
    ...
    public java.sql.Date getDate(int columnIndex) throws SQLException {
    	...
    	if(o==null){
    		...
    		return null;
    	}else if(o instanceof lotus.domino.cso.DateTime){
    		try {
    			date=((lotus.domino.cso.DateTime)o).toJavaDate();
    		} catch (Exception e){
    			throw new LNException("Can't get lotus date",e);
    		}
    	}else throw new LNException("Can't handle "+o.getClass() +" as Date for column "+columnIndex+" with value: "+o);
