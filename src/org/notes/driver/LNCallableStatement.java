...
public class LNCallableStatement extends LNViewPreparedStatement implements CallableStatement{
	protected LNCallableStatement(LNConnection con,String sql)throws SQLException{
		super(con,sql);
	}
